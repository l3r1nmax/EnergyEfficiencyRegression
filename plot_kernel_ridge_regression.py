...
for test_size in heldout:
    ...
    sv_ratio = svr.best_estimator_.support_.shape[0] / test_size
...
for name, estimator in {"KRR": KernelRidge(kernel='rbf', alpha=0.1,
    ...
    for train_test_size in sizes:
        t0 = time.time()
        X_train, X_test, y_train, y_test = \
            train_test_split(X, y, test_size=train_test_size, random_state=rng)
...
train_sizes, train_scores_svr, test_scores_svr = \
    learning_curve(svr, X_train, y_train, train_sizes=heldout,
                   scoring="neg_mean_squared_error", cv=10)
train_sizes_abs, train_scores_kr, test_scores_kr = \
    learning_curve(kr, X_train, y_train, train_sizes=heldout,
                   scoring="neg_mean_squared_error", cv=10)
